#!/usr/bin/env bash
# Start the retriever in r_e, wait for /health, then launch the 80GB trainer in r_t.
...
TRAINING_SCRIPT="${REPO_ROOT}/verl_latest/z_run_qwen3_0.6b_grpo_vllm_instruct_gpu_1_a100_80gb.sh"
