...
install_requires = [
    ...
    "dill",
    "hydra-core",
    # NumPy 2.x required by the locked research env (e.g. pandas 3.x, torch 2.9 stack).
    "numpy>=1.26.0,<3.0.0",
    "pandas",
    "peft",
    "pyarrow>=19.0.0",
    ...
    # vLLM 0.8.x is incompatible with transformers 5.x (PretrainedConfig/dataclass + bundled configs)
