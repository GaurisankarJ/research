...
def default_compute_score(
    ...
    **kwargs,
    ...
    Args:
        ...
        **kwargs: Extra scorer args; ``tokenizer`` is forwarded to ReSearch scoring for MuSiQue / ``train``.
    ...
    elif data_source in ["musique", "MuSiQue", "train"]:
        # ReSearch reward: strict tool-style tags + token F1 vs MuSiQue / Search-R1 labels.
        from . import re_search

        tokenizer = kwargs.get("tokenizer")
        res = re_search.compute_score(
            solution_str,
            ground_truth,
            tokenizer=tokenizer,
        )
