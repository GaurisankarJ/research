...
def compute_data_metrics(batch: DataProto, use_critic: bool = True) -> dict[str, Any]:
    ...
    if "tool_call_counts" in batch.non_tensor_batch:
        ...
        # Alias (ReSearch HTTP search calls per trajectory)
        metrics["re_search/search_calls/min"] = metrics["tool_call_counts/min"]
        metrics["re_search/search_calls/max"] = metrics["tool_call_counts/max"]
        metrics["re_search/search_calls/mean"] = metrics["tool_call_counts/mean"]
